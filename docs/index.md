...
<ul class="multi-column-list">
  <li><a href="armory"><strong>Armory</strong></a></li>
  ...
  <li><strong>Build & character features</strong>
    <ul>
  ...
  <li><strong>Camera features</strong>
    <ul>
      <li><a href="camera_unlock">Camera Unlock</a></li>
    </ul>
  </li>
  <li><strong>Chat features</strong>
    <ul>
  ...
  <li><strong>Instance features</strong>
    <ul>
      <li><a href="alcohol">Alcohol Monitor</a></li>
      <li><a href="damage">Damage Monitor</a></li>
      ...
      <li><a href="timer">Instance Timer</a></li>
  ...
  <li><a href="observer_module"><strong>Observer Module</strong></a>
    <ul>
  ...
  <li><strong>Party features</strong>
    <ul>
  ...
  <li><strong>Progression features</strong>
    <ul>
  ...
  <li><strong>Skill features</strong>
    <ul>
      <li><a href="bonds">Bonds Monitor</a></li>
  ...
  <li><strong>Target features</strong>
    <ul>
      <li><a href="distance">Distance Monitor</a></li>
  ...
  <li><strong>Other features</strong>
    <ul>
      ...
      <li><a href="settings#fps-fix">FPS Fix</a></li>
      <li><a href="gw_settings">GW settings import/export</a></li>
      <li><a href="hints">In-Game Hints</a></li>
      <li><a href="info">Info Window</a></li>
      ...
      <li><a href="theme">Toolbox Theme</a></li>
    </ul>
  </li>
</ul>

<p style="clear: both; font-size: 1.33em; margin-top: 2em;">Have an issue or want a new feature? Check the <a href="{{ site.github.issues_url }}">Issue Tracker</a>!</p>
